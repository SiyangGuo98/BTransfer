...
class telephoneProcessor(DataProcessor):
    """Processor for the MultiNLI data set (GLUE version)."""
...
class TextClassificationProcessor(DataProcessor):
    ...
    def get_labels(self):
        ...
        if self.task_name == "mr":
            ...
            return list(range(5))
        elif self.task_name == "amazon_polarity":
            return ["0", "1"]
    ...
    def _create_examples(self, lines, set_type):
        ...
        for (i, line) in enumerate(lines):
            ...
            if self.task_name == "yelp_review_full":
                examples.append(InputExample(guid=guid, text_a=line[1], short_text=line[1], label=line[0]))
            elif self.task_name == "amazon_polarity":
                examples.append(InputExample(guid=guid, text_a=line[2], label= str(int(line[0])-1) ))    
            ...
            #elif self.task_name in ['ag_news']:
...
processors_mapping = {
    "cola": ColaProcessor(),
    "mnli": MnliProcessor(),
    "telephone_telephone": telephoneProcessor(),
    "government_government": telephoneProcessor(),
    "telephone_letters": telephoneProcessor(),
    "telephone_facetoface": telephoneProcessor(),
    "telephone_government": telephoneProcessor(),
    "telephone_government_0.9": telephoneProcessor(),
    "telephone_government_0.95": telephoneProcessor(),
    "telephone_government_0.99": telephoneProcessor(),
    "telephone_government_1.0": telephoneProcessor(),
    "telephone_government_0.5": telephoneProcessor(),
    "mnli-mm": MnliMismatchedProcessor(),
    "mrpc": MrpcProcessor(),
    "sst-2": Sst2Processor(),
    "yelp_polarity": yelpProcessor(),
    "amazon_polarity": TextClassificationProcessor("amazon_polarity"),
    "imdb": imdbProcessor(),
...
num_labels_mapping = {
    "cola": 2,
    "mnli": 3,
    "telephone_telephone": 3,
    "government_government": 3, 
    "telephone_letters": 3,
    "telephone_facetoface": 3,
    "telephone_government": 3,
    "telephone_government_0.9": 2,
    "telephone_government_0.95": 2,
    "telephone_government_0.99": 2,
    "telephone_government_1.0": 2,
    "telephone_government_0.5": 2,
    "mrpc": 2,
    "sst-2": 2,
    "yelp_polarity": 2,
    "amazon_polarity": 2,
...
output_modes_mapping = {
    "cola": "classification",
    "mnli": "classification",
    "telephone_telephone": "classification",
    "government_government": "classification",
    "telephone_letters": "classification",
    "telephone_facetoface": "classification",
    "telephone_government": "classification",
    "telephone_government_0.9": "classification",
    "telephone_government_0.95": "classification",
    "telephone_government_0.99": "classification",
    "telephone_government_1.0": "classification",
    "telephone_government_0.5": "classification",
...
compute_metrics_mapping = {
    ...
    "telephone_telephone": glue_compute_metrics,
    "telephone_letters": glue_compute_metrics,
    "telephone_facetoface": glue_compute_metrics,
    "telephone_government": glue_compute_metrics,
    "telephone_government_0.9": glue_compute_metrics,
    "telephone_government_0.95": glue_compute_metrics,
    "telephone_government_0.99": glue_compute_metrics,
    "telephone_government_1.0": glue_compute_metrics,
    "telephone_government_0.5": glue_compute_metrics,
    "government_government": glue_compute_metrics,
    "mnli-mm": glue_compute_metrics,
    "mrpc": glue_compute_metrics,
    "sst-2": glue_compute_metrics,
    "imdb": glue_compute_metrics,
    "ag_news": glue_compute_metrics,
    "sts-b": glue_compute_metrics,
    "qqp": glue_compute_metrics,
    "qnli": glue_compute_metrics,
    "anli": glue_compute_metrics,
